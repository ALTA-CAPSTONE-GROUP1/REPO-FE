...
export const Red2Button: FC<Button> = (props) => {
  ...
  return (
    <button
      className="py-2 px-4 w-full bg-white justify-center items-center gap-2 rounded-full border-@Red text-lg  disabled:bg-@Red2 text-@Red font-bold shadow-sm align-middle hover:scale-105 focus:outline-none   transition-all text-md"
      {...props}
    >
      {label}
    </button>
